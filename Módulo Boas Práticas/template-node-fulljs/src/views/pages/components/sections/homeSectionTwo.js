import backgroundTwo from '../../../../assets/sass/images/background/bg2.png'
import darthVader from '../../../../assets/sass/images/elements/vader.png'
...
<section id="section-two" class="section background--two" style="background-image: url(${backgroundTwo})"> 
    ...
    <div class="block-section" id="footer-img">
        ${footer}
    </div>
</section>
`
